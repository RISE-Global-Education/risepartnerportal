...
export default function Cohort2025SubNav({ secret }: { secret: string }) {
  const pathname = usePathname();
  const base = `/${secret}/student-pipeline/cohort-2025`;

  const tabs = [
    { label: "Pending Outreach", href: `${base}/pending-outreach` },
  ];
