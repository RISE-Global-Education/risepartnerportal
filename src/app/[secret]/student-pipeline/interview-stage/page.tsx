...
import InterviewStageClient from "./InterviewStageClient";
...
export default async function InterviewStagePage() {
  ...
  return (
    <div>
      ...
      <InterviewStageClient students={students} userName={userName} />
    </div>
  );
}
